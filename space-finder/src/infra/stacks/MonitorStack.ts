...
export class MonitorStack extends Stack{
    constructor(scope: Construct, id: string, props?: StackProps){
        ...
        const webHookLamda = new NodejsFunction(this, "webHookLamdba", {
            runtime: Runtime.NODEJS_18_X,
            handler: "handler",
            entry: (join(__dirname, "..", "..", "services", "monitor", "handlers.ts")),
        });
        ...
        alarmTopic.addSubscription(new LambdaSubscription(webHookLamda));
